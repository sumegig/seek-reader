...
static constexpr uint8_t  STATS_FILE_VERSION      = 4; // UPDATE: bumped from 3 to 4
...
static_assert(sizeof(BookStatEntry) == 464,
...
static_assert(sizeof(GlobalStats) == 44,
...
class ReadingStatsManager {
 public:
    ...
    void beginSession(const char* cacheKey, const char* title, const char* author,
